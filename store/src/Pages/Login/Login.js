        ...
        <div class="d-flex flex-lg-row flex-column-reverse">
            <div class="card card1">
                <div class="row justify-content-center my-auto">
                    <div class="col-md-8 col-10 my-5">
                        <div class="row justify-content-center px-3 mb-3">
                            <img id="logo" src="https://preview.webpixels.io/web/img/logos/clever-primary.svg"/>
                        </div>
                        <h3 class="mb-5 text-center heading">Shoping Store</h3>
                ...
                <div class="bottom text-center mb-5">
                    <p href="#" class="sm-text mx-auto mb-3"><span style={{marginRight : "15px"}}>Don't have an account?</span><button class="btn btn-white ml-2">Create new</button></p>
                </div>
            </div>
